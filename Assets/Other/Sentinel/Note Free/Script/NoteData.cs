        ...
        public void AddWindow(WindowType type)
        {
            ...
            switch (type)
            {
                ...
                case WindowType.TodoList:
                    data.rect = new Rect(0, 0, 150, 50);
                    data.windowMinSize = new Vector2(150, 50);
                    break;
                case WindowType.Color:
                    data.rect = new Rect(0, 0, 80, 90);
                    data.windowMinSize = new Vector2(80, 90);
                    data.windowMaxSize = new Vector2(80, 90);
                    break;
                ...
                case WindowType.Vector:
                    data.rect = new Rect(0, 0, 400, 50);
                    data.windowMinSize = new Vector2(200, 30);
                    data.windowMaxSize = new Vector2(400, 50);
                    break;
            }
